            ...
            switch (myKey) {
                ...
                case 'j':
                    ...
                    if(prev.length) {
                        ...
                        jQuery(jQuery('article.entry-common').get().reverse()).each(function(i, article) { 
                ...
                case 'k':
                    ...
                    if(next.length) {
                        ...
                        scrollTop = jQuery(window).scrollTop();
                        jQuery('article.entry-common').each(function(i, article) { 
                            var articletop = jQuery(article).offset().top;
                ...
                case 'c':
                    ...
                    if(singlecomments.length) {
                        ...
                        jQuery(jQuery('article.entry-common').get().reverse()).each(function(i, article) { 
                            ...
                            if ( scrollTop > articletop - 90 ) { 
                                //we have the previous post
                                var link = jQuery(article).find('.entry-name a').attr("href");
